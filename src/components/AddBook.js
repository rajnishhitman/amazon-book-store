                ...
                <div className="col-md">
                    <form onSubmit={handleSubmit(onFormSubmit)}>
                        <div className="mb-2 mt-3">
                            ...
                            <small className="form-text text-danger">{errors.bookCategory && "This field is required"}</small>
                        </div>
                        <div className="mb-2 mt-3">
                        ...
                        <div className="mb-2">
                            <label for="bookQuantity" className="form-label">Quantity</label>
                        ...
                        <button className="btn btn-warning mb-2">Add</button>
                    </form>
                </div>
            </div>
        </div>
